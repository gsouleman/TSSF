...
/**
 * If > 0, the app always uses this tbl_facility id (session is forced each request).
 * Set to 0 in config.local.php for true multi-site switching.
 */
if (!defined('HMS_FIXED_FACILITY_ID')) {
    define('HMS_FIXED_FACILITY_ID', 1);
}
