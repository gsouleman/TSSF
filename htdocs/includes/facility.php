...
{
    // Never return 0: many tables FK to tbl_facility(id); session may store 0 before multi-site is resolved.
    if (defined('HMS_FIXED_FACILITY_ID') && (int) HMS_FIXED_FACILITY_ID > 0) {
        return (int) HMS_FIXED_FACILITY_ID;
    }

    return max(1, (int) ($_SESSION['facility_id'] ?? 1));
}
