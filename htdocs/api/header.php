...
<body class="hms-ehr-shell">
    ...
    if (isset($connection) && $connection instanceof mysqli && !empty($_SESSION['name']) && !empty($_SESSION['user_id'])
        && function_exists('hms_staff_portal_nav_is_limited') && hms_staff_portal_nav_is_limited((string) ($_SESSION['role'] ?? ''))) {
            ...
            <div class="sidebar-inner slimscroll">
                ...
                <nav id="sidebar-menu" class="hms-sidebar-nav sidebar-menu" role="navigation" aria-label="Main">
                    <ul class="list-unstyled mb-2 pb-3 hms-sidebar-list">
                        ...
                        <?php } else { ?>
                        <li class="<?php echo hms_nav_active('dashboard.php'); ?> hms-sidebar-item">
                            <a href="<?php echo hms_h($hmsSidebarHomeHref); ?>" title="Dashboard">
                        ...
                        <li class="<?php echo hms_nav_active('financials.php'); ?> hms-sidebar-item">
                            <a href="financials.php" title="Financials">
                                <i class="fa fa-line-chart" aria-hidden="true"></i><span>Financials</span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <?php } ?>
                        <?php if ((!empty($hmsSn['manage_catalog'])) && ($hmsIsDeployAdmin || hms_can($connection, 'billing.read')) && $hmsNavItemShow('m_service_catalog')) { ?>
