...
$(document).ready(function($) {
	...
	function init() {
		...
		$('#sidebar-menu a').on('click', function(e) {
			/* Modern HMS sidebar (SOA): Bootstrap collapse + plain links — do not run legacy PreClinic slide menu */
			if ($(this).closest('ul.hms-sidebar-list').length) {
				return;
			}
	...
	// Datatable (other pages — search off by default)
